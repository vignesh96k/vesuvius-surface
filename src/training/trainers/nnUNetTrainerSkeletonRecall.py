...
from training.losses import DC_SkelRec_and_CE_loss, SkeletonTargetAdapter
from training.skeleton import DEFAULT_TUBE_DILATIONS
...
class nnUNetTrainerSkeletonRecall(nnUNetTrainer):  # noqa: N801 - nnU-Net naming
    ...
    def __init__(self, *args, **kwargs) -> None:
        # Signature passthrough: nnU-Net has changed the trailer of this
        # signature between releases and we add nothing to it.
