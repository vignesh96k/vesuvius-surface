...
from vesuvius_surface.data.io import build_volume_index, read_metadata_csv
from vesuvius_surface.data.schema import LABEL_BG, LABEL_IGNORE, LABEL_SURFACE, TEST_IMAGES_DIRNAME
